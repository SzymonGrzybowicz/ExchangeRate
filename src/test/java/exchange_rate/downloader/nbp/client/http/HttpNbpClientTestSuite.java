...
import exchange_rate.downloader.http.converter.Converter.DataFormat;
import exchange_rate.exception.checked.NotFoundException;
import exchange_rate.exception.unchecked.BadRequestException;
import exchange_rate.exception.unchecked.ConnectionException;
...
public class HttpNbpClientTestSuite {
	...
	public void test_getActual_responseCode200() throws IOException {
		...
		HttpNbpDownloader downloader = new HttpNbpDownloader();
	...
	@Test
	public void test_getForPeriod_responseCode200() throws IOException {
		// Given
		String body = "testBody";
		Response responseMock = mockResponse(200, body);
		OkHttpClient clientMock = mockHttpClient(responseMock);
		...
		// When
		downloader.getForPeriod(Currency.EURO, LocalDate.MIN, LocalDate.MAX);

		// Then
		verify(converterMock).convertCurrencyListResponse(body);
	}

	@Test
	public void test_getForPeriod_responseCode418() throws IOException {
		// Given
		Response responseMock = mockResponse(418, "");
		OkHttpClient clientMock = mockHttpClient(responseMock);
	...
	@Test
	public void test_getForPeriod_responseCode404() throws IOException {
		// Given
		Response responseMock = mockResponse(404, "");
		OkHttpClient clientMock = mockHttpClient(responseMock);
	...
	@Test
	public void test_getForPeriod_IOException() throws IOException {
		// Given
		Call callMock = Mockito.mock(Call.class);
		when(callMock.execute()).thenThrow(IOException.class);

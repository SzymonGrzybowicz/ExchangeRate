package exchange_rate.downloader.http;
...
import exchange_rate.exception.unchecked.DataFormatException;
...
public class HttpNbpDownloader implements NbpDownloader {
	...
	@Override
	public List<ExchangeRate> getForPeriod(Currency currency, LocalDate startDate, LocalDate endDate) {
